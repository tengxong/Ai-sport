...
# ==========================
#  Database Config (PostgreSQL: ai-sport)
# ==========================
...
def get_connection():
    """คืนค่า connection ไปยังฐานข้อมูล ai-sport"""
    # timeout 5 วินาที เพื่อไม่ให้ค้างเมื่อ DB ไม่มีหรือผิด (เช่นบน Render ยังไม่ตั้ง DATABASE_URL)
    connect_timeout = 5
    if DATABASE_URL:
